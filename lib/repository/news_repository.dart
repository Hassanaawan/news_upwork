...
class NewsRepository {
  Future<CategoriesNewsModel> fetchNewsCategoires(String category) async {
    String newsUrl =
        'https://newsapi.org/v2/everything?q=$category&apiKey=6754271eefe349cf8dc107174bc014e1';
  ...
  Future<NewsChannelsHeadlinesModel> fetchNewsChannelHeadlinesApi(
    ...
    String newsUrl =
        'https://newsapi.org/v2/top-headlines?sources=${newsChannel}&apiKey=6754271eefe349cf8dc107174bc014e1';
    print(newsUrl);
    final response = await http.get(Uri.parse(newsUrl));
